...
2. Run `corepack pnpm --filter @irudd-le/overlay version patch --no-git-tag-version`, capture the resulting version from `apps/overlay/package.json`, and run `corepack pnpm typecheck`.
